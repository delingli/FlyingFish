...
public class Constants {
    ...
    public static final String SERVER_HOST = "10.10.20.240";
//    public static final String SERVER_HOST = "192.168.8.240";
//    public static final String SERVER_HOST = "192.168.10.240";
    public static final String RABBIT_NAME = "itc";
    public static final String RABBIT_PASSWORD = "itc.pass";
    public static final int RABBIT_PORT = 5577;
//    public static final int RABBIT_PORT = 5674;
