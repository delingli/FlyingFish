...
public class MarqueeView  extends SurfaceView implements SurfaceHolder.Callback{
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.MarqueeViewzz, defStyleAttr, 0);
        mTextColor = a.getColor(R.styleable.MarqueeViewzz_textcolor, Color.RED);
        mTextSize = a.getDimension(R.styleable.MarqueeViewzz_textSize, 48);
        mIsRepeat=a.getBoolean(R.styleable.MarqueeViewzz_isRepeat,false);
        mStartPoint=a.getInt(R.styleable.MarqueeViewzz_startPoint,0);
        mDirection=a.getInt(R.styleable.MarqueeViewzz_direction,0);
        mSpeed=a.getInt(R.styleable.MarqueeViewzz_speed,20);
        a.recycle();
